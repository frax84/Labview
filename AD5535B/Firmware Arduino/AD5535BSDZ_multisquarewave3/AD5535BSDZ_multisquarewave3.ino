  ...
  if (Serial.available()) {
    ...
    switch (command) {
      ...
      case UPDATE_CHANNEL:    //this is used to update the amplitude of a single channel during runtime
        ...
        uint8_t chanWaveNum = dataBuffer[0]; //stores the number of the channel to be updated
        ...
        break;
      case UPDATE_FREQ:    //this is used to update the frequency of the produced square wave during runtime
